...
- Разработка программ для автоматизированной обработки временных рядов гидрометеорологической информации (Python): pandas, numpy. Основное направление контроль и чистка данных, расчет описательных статистик

- Написание программ парсинга динамических сайтов (Selenium)
